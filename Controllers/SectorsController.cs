...
namespace WorkshopsGov.Controllers
{
    public class SectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Active,CreatedAt,UpdatedAt")] Sector sector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Active,CreatedAt,UpdatedAt")] Sector sector)
        {
            if (id != sector.Id)
            {
                return NotFound();
