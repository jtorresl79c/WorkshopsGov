...
namespace WorkshopsGov.Controllers
{
    public class RequestServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Folio,ApplicationUserId,VehicleId,DepartmentId,Description,ReceptionDate,Active,CreatedAt,UpdatedAt")] RequestService requestService)
        {
